...
class AsyncServiceHelper
{
    ...
    protected static boolean InstallServiceQuiet(Context context)
    {
        ...
        {
            Log.e(TAG, "Exception during service installation: ", e);
            result = false;
        }
    ...
    protected ServiceConnection mServiceConnection = new ServiceConnection()
    {
        public void onServiceConnected(ComponentName className, IBinder service)
        {
            ...
            else
            {
                ...
                try
                {
                            ...
                            InstallCallbackInterface InstallQuery = new InstallCallbackInterface() {
                                ...
                                public void install() {
                                    ...
                                    try
                                    {
                                        ...
                                        Log.e(TAG, "RemoteException during library installation: ", e);
                    ...
                    else
                    {
                        ...
                        if (initOpenCVLibs(path, libs))
                        {
                            ...
                            String buildInformation = Core.getBuildInformation();
                            if (buildInformation != null) {
                                for (String str : buildInformation.split(System.lineSeparator()))
                                    Log.i(TAG, str);
                            }
                ...
                {
                    Log.e(TAG, "RemoteException in onServiceConnected: ", e);
                    Log.d(TAG, "Init finished with status " + LoaderCallbackInterface.INIT_FAILED);
                    Log.d(TAG, "Unbind from service");
                    mAppContext.unbindService(mServiceConnection);
                    Log.d(TAG, "Calling using callback");
    ...
    private boolean loadLibrary(String AbsPath)
    {
        ...
        {
            Log.d(TAG, "Cannot load library \"" + AbsPath + "\"", e);
            result = false;
        }
